...
export default function About() {
  ...
  return (
    <section id="about" className="py-32 relative border-t border-zinc-950/20 bg-lime-400">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex items-center gap-4 mb-16">
          <span className="text-xs font-space tracking-widest text-zinc-800">01 / ABOUT</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-5">
            <h2 className="text-4xl md:text-5xl font-space font-bold tracking-tighter leading-tight">
              More than
              <br />
              <span className="text-zinc-800">just code.</span>
            </h2>
          </div>
          ...
          <div className="flex flex-wrap md:flex-nowrap items-center justify-between gap-4 md:gap-0">
            {timelineSteps.map((step, index) => (
              <div key={step} className="flex items-center w-full md:w-auto">
                ...
                >
                  <div className="w-16 h-16 rounded-full border border-zinc-950/20 bg-lime-400/50 flex items-center justify-center mb-4 group-hover:border-zinc-950 group-hover:bg-zinc-950/10 transition-all duration-500">
                    <span className="text-xs font-space tracking-widest text-zinc-900 group-hover:text-zinc-950">
                      0{index + 1}
                    </span>
                  </div>
                  <span className="text-sm font-space font-bold tracking-widest text-zinc-800">
                    {step}
                  </span>
                </motion.div>
                ...
                {index < timelineSteps.length - 1 && (
                  <div className="hidden md:flex flex-1 items-center justify-center px-4">
                    <div className="h-[1px] w-full max-w-[100px] bg-zinc-950 relative">
                      <ArrowRight className="absolute right-0 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-900 translate-x-1/2" />
                    </div>
                  </div>
                )}
              </div>
